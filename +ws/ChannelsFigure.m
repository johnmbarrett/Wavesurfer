classdef ChannelsFigure < ws.MCOSFigure
    properties  % protected by gentleman's agreement
        DeviceNamePopupLabelText % TODO : multi-device for all the other types of channel so I can get rid of this
        DeviceNamePopup
...
%                                 scaleAndUnitsControlsWidth);
        ...
        function layoutAIPanel_(self, ...
            ...
            % Channel Device Name                                            
            deviceNameColLeftX = channelNameColLeftX + channelNameEditWidth + spaceBetweenChannelNameAndTerminalNameWidth ;
            ws.alignTextInRectangleBang(self.AIDeviceNameColTitleText, ...
                                                [deviceNameColLeftX titleRowBottomY aiDeviceNamePopupWidth titleRowHeight], ...
                                                'cm');
            
            % Channel Terminal Name                                            
            terminalNameColLeftX = deviceNameColLeftX + aiDeviceNamePopupWidth + spaceBetweenTerminalAndRestWidth ;
            ...
            for i=1:nAIs ,
                ...
                set(self.AIDeviceNamePopups(i), ...
                    'Position',[xColLeft aiYRowBottom aiDeviceNamePopupWidth rowHeight]);  % shim to make look nice
                % terminal name
                xColLeft = xColLeft + aiDeviceNamePopupWidth + spaceBetweenTerminalAndRestWidth ;
        ...
        function layoutAOPanel_(self, ...
            ...
            % Channel Terminal Name                                            
            terminalNameColLeftX = deviceNameColLeftX + deviceNamePopupWidth + spaceBetweenTerminalAndRestWidth ;
            ...
            for i=1:nAOs ,
                ...
                % terminal name
                xColLeft = xColLeft + deviceNamePopupWidth + spaceBetweenTerminalAndRestWidth ;
...
%         end        
        ...
        function updateAIPanelControlPropertiesImplementation_(self, normalBackgroundColor, warningBackgroundColor)            
            ...
            deviceNameForEachChannel = model.Acquisition.AnalogDeviceNames;
            ...
            for i=1:nAIs ,
                ...
                ws.setPopupMenuItemsAndSelectionBang(self.AIDeviceNamePopups(i), ...
                                                             allDeviceNames, ...
                                                             deviceNameForEachChannel{i}); % TODO : device name per channel
                set(self.AIDeviceNamePopups(i) , ...
    ...
    methods (Access = protected)
        ...
        function updateAOPanelControlsInExistance_(self)
            ...
            if nAOsBefore<nAOs ,
                ...
                self.AODeviceNamePopups(nAOs) = 0 ;
